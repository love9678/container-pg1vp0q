...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pg1vp0q.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pg1vp0q.containers.anotherwebservice.com/
...
```
git clone git@github.com:love9678/container-pg1vp0q.git
cd container-pg1vp0q
```
...
```
docker attach container-pg1vp0q
```
